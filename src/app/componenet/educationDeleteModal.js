...
function EducationDeleteModal({personToDelete, loading=false,setCloseDeleteModal,handleDelete}) {
  return (
            ...
            <div className="modal-dialog modal-sm" role="document">
              <div className="modal-content">
                ...
                <div className="modal-body pt-3">
                  <h5>Do you want to delete this education record?</h5>
                  {personToDelete && (
                    <p>
                      <strong>{personToDelete.class_name} - {personToDelete.institute}</strong>
                    </p>
                  )}
