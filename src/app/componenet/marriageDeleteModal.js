...
function MarriageDeleteModal({personToDelete, loading=false,setCloseDeleteModal,handleDelete}) {
  return (
            ...
            <div className="modal-dialog modal-sm" role="document">
              <div className="modal-content">
                ...
                <div className="modal-body pt-3">
                  ...
                  {personToDelete && (
                    <p>
                      <strong>{personToDelete.relationship_type}</strong>
                    </p>
                  )}
...
export default MarriageDeleteModal;