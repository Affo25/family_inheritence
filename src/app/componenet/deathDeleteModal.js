...
function DeathDeleteModal({personToDelete, loading=false, setCloseDeleteModal, handleDelete}) {
  return (
            ...
            <div className="modal-dialog modal-sm" role="document">
              <div className="modal-content">
                ...
                <div className="modal-body pt-3">
                  <h5>Do you want to delete this death record?</h5>
                  {personToDelete && (
                    <p>
                      <strong>{personToDelete.death_place} - {personToDelete.death_reason}</strong>
                    </p>
                  )}
...
export default DeathDeleteModal;